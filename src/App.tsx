...
export function App() {
  ...
  const renderMain = () => {
    ...
    if (
      ...
      return <CollectionView key={route.type} type={route.type as ItemType} />;
    }
    return <Dashboard />;
  };

  return (
    <div className="flex h-full text-[#33312c] dark:text-[#cdd1c8]">
      <Sidebar />
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center gap-3 border-b border-[#e7e4de] bg-[#fbfaf7] px-6 py-4 dark:border-[#232820] dark:bg-[#171b14]">
